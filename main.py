...
colour_list = ["\033[36;1m", "\033[31;1m", "\033[32;22m", "\033[33;6m", "\033[0;32m", "\033[;1m", "\033[;7m", "\033[;4m", "\033[;6m", "\033[36;7m", "\033[1;31m", "\033[4;31m"]
...
def register():
  ...
  sleep(1)
  print("\n"*4)
  print(f"\033{colour_list[0]}Congratulations, You now have a Bronze Burbet Account\033[0m")
  print()
  return username
    ...
    for item in login_details:
      if username == item[0]:
        ...
        while passwordloop == True:
          password = getpass.getpass("Please Input Password (Input is hidden) >> ").lower()
          if password == item[1]:
            print("...")
            print("\n"*2)
            sleep(1)
            ...
            print()
            sleep(1)
            print(f"\033{colour_list[10]}Password Not Found, Please Try Again\033[0m")
            wrong_count += 1
          if wrong_count == 8:
      ...
      print()
      sleep(1)
      print(f"\033{colour_list[10]}Username Not Found, Please Try Again\033[0m")
      print()
      sleep(1)
      wrong_count += 1
    if wrong_count == 8:
...
def auth0():
  ...
  print(f"\033{colour_list[11]}Unfortunately You have been blocked from Burbet Lite for 100 seconds.\033[0m")
  print()
...
print(f"\033{colour_list[9]}___________________WELCOME TO BURBET LITE___________________\033[0m")
print(f"\033{colour_list[9]}___________________________V.0.1____________________________\033[0m")
print()
sleep(1)
